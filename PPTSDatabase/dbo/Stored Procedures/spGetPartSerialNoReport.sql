-- ====================================================================================
-- Application 		: PPTS
-- Object Name		: spGetPartSerialNoReport 
-- Author			: Namdeo
-- Created			: 09/12/2015
...
CREATE PROCEDURE [dbo].[spGetPartSerialNoReport]
@PartSrNoorBatchCode as varchar(30),
@PartSerialNowise as bit
AS
BEGIN

	SET NOCOUNT ON;
	BEGIN TRY
		if(@PartSerialNowise=1 )
		begin
			select 
			...
			where 
				vw_TRN_BoxBarcodeDetails.PartSerialNo=@PartSrNoorBatchCode
			order by 
		...
		begin
			...
			from
				...
				on vw_TRN_PalletSerialNo.TRN_PalletSerialNo_ID=vw_TRN_InvoiceDetails.TRN_PalletSerialNo_ID
			where 
				vw_TRN_BoxBarcodeDetails.PartBatchCode=@PartSrNoorBatchCode
			order by 
				vw_TRN_BoxSerialNo.TRN_BoxSerialNo_ID,vw_TRN_BoxBarcodeDetails.PartSerialNo ;
		end
